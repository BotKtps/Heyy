...
def pindah_button(button):
    """Memindahkan tombol ke posisi acak dalam jendela."""
...
def tekan_ya():
    """Menangani aksi ketika tombol 'Ya' ditekan."""
    messagebox.showinfo("Jawaban", "Now you are my partner")
    buka_whatsapp()

def tekan_tidak():
    """Menangani aksi ketika tombol 'Tidak' ditekan."""
    pindah_button(tidak_button)

def buka_whatsapp():
    """Membuka WhatsApp dengan pesan yang telah dikodekan."""
...
# Menambahkan label pertanyaan
label = tk.Label(frame, text="I have a crush on you,\nWant to be my partner?", 
                 font=("Helvetica", 16, "bold"), bg='#FFC0CB', fg='#FF69B4', justify=tk.CENTER)
label.pack(pady=20)
